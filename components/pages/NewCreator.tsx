        ...
        try {
            ...
            const enhancedQuestions = await Promise.all(aiResult.questions.map(async (gq: any) => {
                const qObj = { 
                    ...gq, 
                    id: uuid(), 
                    correctOptionIds: gq.correctOptionIds || [gq.correctOptionId],
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <CyberInput type="number" value={genParams.count} onChange={(e) => setGenParams({...genParams, count: parseInt(e.target.value) || 5})} className="h-12 font-mono text-lg" min={1} max={50} />
                                    </div>
                                </div>
